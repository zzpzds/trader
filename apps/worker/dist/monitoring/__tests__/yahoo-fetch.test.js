...
function createMockChartResult(symbol, quotes) {
    return {
        meta: {
            currency: "USD",
            symbol,
...
describe("fetchPrices", () => {
    ...
    it("returns parsed price data on success", async () => {
        mockChart.mockResolvedValue(createMockChartResult("QQQ", [
    ...
    it("passes period1 to chart based on period string", async () => {
        mockChart.mockResolvedValue(createMockChartResult("SPY", [
